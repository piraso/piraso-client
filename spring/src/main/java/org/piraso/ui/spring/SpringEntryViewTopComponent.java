...
package org.piraso.ui.spring;

import org.piraso.api.spring.SpringRemotingEntry;
...
@ActionID(category = "Window", id = "org.piraso.ui.log4j.SpringEntryViewTopComponent")
@ActionReference(path = "Menu/Window", position = 337)
@ConvertAsProperties(dtd = "-//org.piraso.ui.log4j//SpringEntryView//EN", autostore = false)
@TopComponent.Description(preferredID = "SpringEntryViewTopComponent", iconBase= "org/piraso/ui/spring/icons/spring.png", persistenceType = TopComponent.PERSISTENCE_ALWAYS)
