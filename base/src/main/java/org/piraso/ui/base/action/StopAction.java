...
import org.piraso.ui.base.cookie.StartCookie;
...
@ActionID(category = "Tools", id = "org.piraso.ui.base.action.StartAction")
@ActionRegistration(iconBase= "org/piraso/ui/base/icons/start.png", iconInMenu=true, displayName = "#CTL_StartAction")
@ActionReferences({
