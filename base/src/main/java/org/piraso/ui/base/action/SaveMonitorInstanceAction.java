...
@ActionID(category = "File", id = "org.piraso.ui.base.action.SaveMonitorInstanceAction")
@ActionRegistration(iconBase = "org/piraso/ui/base/icons/save.png", displayName = "#CTL_SaveAction")
@ActionReferences({
