...
*/
@ActionID(category = "Window", id = "org.piraso.ui.base.HttpRequestViewTopComponent")
@ActionReference(path = "Menu/Window", position = 340)
@ConvertAsProperties(dtd = "-//org.piraso.ui.base//RequestView//EN", autostore = false)
@TopComponent.Description(preferredID = "HttpRequestViewTopComponent", iconBase= "org/piraso/ui/base/icons/location_http.png", persistenceType = TopComponent.PERSISTENCE_ALWAYS)
