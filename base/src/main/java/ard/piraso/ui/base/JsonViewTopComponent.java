...
@TopComponent.Description(preferredID = "JsonViewTopComponent", iconBase="ard/piraso/ui/base/icons/json.png", persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "output", openAtStartup = false)
@TopComponent.OpenActionRegistration(displayName = "#CTL_JsonViewAction", preferredID = "JsonViewTopComponent")
public final class JsonViewTopComponent extends TopComponent {
