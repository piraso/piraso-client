...
@ActionID(category = "File", id = "ard.piraso.ui.base.action.OpenMonitorInstanceAction")
@ActionRegistration(iconBase = "ard/piraso/ui/base/icons/open.png", displayName = "#CTL_OpenAction")
@ActionReferences({
