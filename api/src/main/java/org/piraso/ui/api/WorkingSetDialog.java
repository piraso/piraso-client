 ...
 * @author adeleon
 */
public final class WorkingSetDialog extends AbstractDialog {
     ...
     */
    public WorkingSetDialog() {
        super();
        setTitle("Manage Working Set");
    ...
    public void refresh() {
        ...
        if(CollectionUtils.isNotEmpty(model.getPreferences())) {
            for(WorkingSetSettings.Child child : model.getPreferences()) {
                tableModel.addRow(new Object[]{child.getName(), child.getRegex()});
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(WorkingSetDialog.class, "WorkingSetDialog.jLabel1.text_1")); // NOI18N

        jtable.setModel(tableModel);
        jScrollPane1.setViewportView(jtable);

        btnAdd.setText(org.openide.util.NbBundle.getMessage(WorkingSetDialog.class, "WorkingSetDialog.btnAdd.text_1")); // NOI18N
        ...
        btnRemove.setText(org.openide.util.NbBundle.getMessage(WorkingSetDialog.class, "WorkingSetDialog.btnRemove.text_1")); // NOI18N
        ...
        btnEdit.setText(org.openide.util.NbBundle.getMessage(WorkingSetDialog.class, "WorkingSetDialog.btnEdit.text_1")); // NOI18N
        ...
        btnSave.setText(org.openide.util.NbBundle.getMessage(WorkingSetDialog.class, "WorkingSetDialog.btnSave.text_1")); // NOI18N
        ...
        btnCancel.setText(org.openide.util.NbBundle.getMessage(WorkingSetDialog.class, "WorkingSetDialog.btnCancel.text_1")); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        WorkingSetInputDialog dialog = new WorkingSetInputDialog();
        ...
        if(!dialog.isCancelled()) {
            ...
            for(int i = 0; i < tableModel.getRowCount(); i++) {
                if(StringUtils.equals(dialog.getRegex(), String.valueOf(tableModel.getValueAt(i, 0)))) {
                    tableModel.setValueAt(dialog.getWorkingSetName(), jtable.getSelectedRow(), 0);
                    tableModel.setValueAt(dialog.getRegex(), jtable.getSelectedRow(), 1);
                    return;
                }
            }

            tableModel.addRow(new Object[]{
                    dialog.getWorkingSetName(),
                    dialog.getRegex()
            });
        }
    ...
    private void removeWorkingSet(String workingSetName) {
        for(int i = 0; i < tableModel.getRowCount(); i++) {
            if(StringUtils.equals(workingSetName, String.valueOf(tableModel.getValueAt(i, 0)))) {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        String name = (String) tableModel.getValueAt(jtable.getSelectedRow(), 0);
        String regex = (String) tableModel.getValueAt(jtable.getSelectedRow(), 1);
        dialog.setWorkingSetName(name);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        WorkingSetSettings model = new WorkingSetSettings();

        for(int i = 0; i < tableModel.getRowCount(); i++) {
            String name = (String) tableModel.getValueAt(i, 0);
            String regex = (String) tableModel.getValueAt(i, 1);

            model.add(name, regex);
        }
